<#
 Generates WAV audio files for Lesson 2 by parsing src\data\lessons\l02.ts.
 ...
 Saves files to public\audio\lessons\l02\.
#>

param(
  [string]$LessonFile = "src\data\lessons\l02.ts",
  [string]$OutDir = "public\audio\lessons\l02",
  [int]$Rate = 0,
  [int]$Volume = 100,
