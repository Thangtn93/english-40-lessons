...
export const lesson5: Lesson = {
  ...
  extra: {
    vocabulary: [
      ...
      { term: "SDK", meaning: "bộ công cụ phát triển", example: "We provide SDKs for JavaScript and Java." },
      { term: "pricing", meaning: "giá", example: "Our pricing is tier-based for different volumes." },
      { term: "tier", meaning: "gói mức", example: "Enterprise tier includes premium support." },
      { term: "onboarding", meaning: "khởi tạo khách hàng", example: "Onboarding takes less than a day." },
      { term: "SLA", meaning: "cam kết dịch vụ", example: "We offer a 99.9% uptime SLA." },
      { term: "uptime", meaning: "thời gian hoạt động", example: "Uptime is monitored by Prometheus." },
      { term: "latency", meaning: "độ trễ", example: "Average API latency is under 100ms." },
      { term: "dashboard", meaning: "bảng điều khiển", example: "The dashboard shows real-time KPIs." },
      { term: "trial", meaning: "dùng thử", example: "We offer a 14-day free trial." },
      { term: "subscription", meaning: "đăng ký trả phí", example: "Subscription renews monthly with discounts annually." },
      { term: "feedback", meaning: "phản hồi", example: "Client feedback helped refine our workflow." },
    ],
    sentencePatterns: [
      { pattern: "Our product helps [persona] [benefit] by [solution].", example: "Our product helps finance teams reconcile faster by automating matching." },
    ...
    practice: [
      { title: "Soạn elevator pitch", prompt: "Viết 4–5 câu giới thiệu sản phẩm cho khách hàng mới.", sample: "We help finance teams reconcile payments faster. Key features include real-time analytics and automated alerts. It integrates with SAP via REST APIs. Pricing starts at $99/month with a 14-day trial." },
